...
{
    /// <summary>
    /// Clase que contiene todas las propiedades y funciones sobre la trama de respuesta de abono
    /// </summary>
    internal class mensaje210
    {
        #region "Propiedades"
        /// <summary>
        /// Identificador del tipo de mensaje
        /// </summary>
        internal String tipoMensaje = "210";
        /// <summary>
        /// codigo de producto
        /// </summary>
        ...
        /// <summary>
        /// Número de autorización sobre la solicitud
        /// </summary>
        internal int numeroAutorizacion = 0;
        /// <summary>
        /// Código de respuesta sobre la solicitud
        /// </summary>
        internal Int16 codigoRespuesta = 0;
        /// <summary>
        ...
        /// <summary>
        /// Tamaño para el número de autorización
        /// </summary>
        private Int16 tamanoNumeroAutorizacion = 6;
        /// <summary>
        /// Tamaño para el código de respuesta
        /// </summary>
        private Int16 tamanoCodigoRespuesta = 2;
        /// <summary>
        ...
        internal Boolean desgloceTrama(String trama)
        {
            try
            {
                ...
                numeroAutorizacion = int.Parse(trama.Substring(posicionSiguiente, tamanoNumeroAutorizacion));
                posicionSiguiente += tamanoNumeroAutorizacion;
                codigoRespuesta = Int16.Parse(trama.Substring(posicionSiguiente, tamanoCodigoRespuesta));
                posicionSiguiente += tamanoCodigoRespuesta;
        ...
        internal String obtenerTrama()
        {
            try
            {
                StringBuilder constructor = new StringBuilder();

                constructor.Append(tipoMensaje);
                constructor.Append(codigoProducto);
                constructor.Append(monto);
                constructor.Append(fechaHora);
                constructor.Append(systemTrace);
                constructor.Append(horaTerminal);
                constructor.Append(fechaTerminal);
                constructor.Append(fechaContable);
                constructor.Append(fechaEntrada);
                constructor.Append(lladquiriente);
                constructor.Append(llissuer);
                constructor.Append(numeroReferencia);
                constructor.Append(numeroAutorizacion);
                constructor.Append(codigoRespuesta);
                constructor.Append(identificadorTerminal);
                constructor.Append(datosTienda);
                constructor.Append(codigoMoneda);
                constructor.Append(llldatosAdicionales);
                constructor.Append(lllnumeroTelefonico);
