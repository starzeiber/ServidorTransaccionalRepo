...
namespace ServidorCore
{
    ...
    public class ServidorTransaccional<T,S>
        ...
        where S : EstadoDelServidorBase, new()
    {
        ...
        /// </summary>
        private AdminEstadosDeCliente<T> administradorDeEstadosDeSockets;
        ...
        public ServidorTransaccional(Int32 numeroConexionesSimultaneas, Int32 tamanoBuffer, int backLog)
        {
            ...
            administradorDeEstadosDeSockets = new AdminEstadosDeCliente<T>(numeroConexionesSimultaneas);
        ...
        public void inicializarServidor()
        {
            ...
            SocketAsyncEventArgs eventArgDeRecepcion, eventArgDeEnvio;
            ...
            {                
                ...
                //SocketAsyncEventArgs necesita un objeto con la información de cada cliente para su administración
                eventArgDeEnvio.UserToken = estadoDelCliente;
                ...
                estadoDelCliente.saeaDeEnvio = eventArgDeEnvio;
                ...
                administradorDeEstadosDeSockets.ingresarUnElemento(estadoDelCliente);
            }
        }
        ...
        {            
            ...
            if (gotLock)
            {
                try
                {
                    ...
                    if (listaClientes.ContainsKey(socketDeTrabajoInfoCliente.idUnicoCliente))
                        listaClientes.Remove(socketDeTrabajoInfoCliente.idUnicoCliente);
                    else
            ...
            Guid tmpGuid = socketDeTrabajoInfoCliente.idUnicoCliente;

            // se llama a la secuencia de cerrando para tener un flujo de eventos
            estadoDelServidorBase.OnClienteCerrado(socketDeTrabajoInfoCliente);
            ...
            bool receivedSignal = socketDeTrabajoInfoCliente.esperandoEnvio.WaitOne(10000, false);
        ...
        {            
            ...
            if (!estadoDelCliente.socketDeTrabajo.Connected)
            {
                ...
                CloseClientSocket(estadoDelCliente);
                return;
            }
            ...
            colaDeProcesamiento(estadoDelCliente);
        }
        ...
        private void procesarSolicitudDeAceptacionDeConexion(object sender, SocketAsyncEventArgs e)
        {
            ...
            // si el cliente pasó todas las validaciones entonces se le asigna ya un estado de trabajo del pool con todas sus propiedes
            estadoDelCliente = administradorDeEstadosDeSockets.obtenerUnElemento();
            estadoDelCliente.SetParentSocketServer(this);
            ...
            if (estadoDelServidorBase.mensajeBienvenida(estadoDelCliente) != "")
            {
                ...
                try
                {
                    ...
                    willRaiseEvent = estadoDelCliente.socketDeTrabajo.SendAsync(estadoDelCliente.saeaDeRecepcion);                    
                    if (!willRaiseEvent)
                        // se llama a la función que completa el flujo de envío cuando la respuesta es false,
                        // de manera forzada ya que se tiene asignado un manejador de eventos a esta función
                        // en su evento callback
                        OnIOCompleted(estadoDelCliente.socketDeTrabajo, estadoDelCliente.saeaDeRecepcion);                    
                }
                catch (Exception ex)
                {
                ...
                case SocketAsyncOperation.Send:
                    ...
                    else if (e == estadoDelCliente.saeaDeRecepcion)
                    {
                        ...
                        if (e.SocketError == SocketError.Success)
                        {
                            ...
                            this.procesarEnvioCiclico(estadoDelCliente);
                        }
                        else
                        {
                            estadoDelCliente.ultimoErrorConexionCliente = e.SocketError.ToString();
        ...
        private void procesarRecepcion(T estadoDelCliente)
        {
            ...
            {
                this.CloseClientSocket(estadoDelCliente);
            ...
            else
            {
                ...
                if (estadoDelCliente.secuenciaDeRespuestasAlCliente != "")
                {
                    ...
                    try
                    {
                        ...
                        bool willRaiseEvent = estadoDelCliente.socketDeTrabajo.SendAsync(saeaRecepcion);
                        if (!willRaiseEvent)
                            // Si se tiene una respuesta False de que el proceso está pendiente, se completa el flujo,
                            // de manera forzada ya que se tiene asignado un manejador de eventos a esta función
                            // en su evento callback
                            OnIOCompleted(estadoDelCliente.socketDeTrabajo, saeaRecepcion);
                    }
                    catch (Exception)
                    {
                        CloseClientSocket(estadoDelCliente);
                    ...
                    if (estadoDelCliente.socketDeTrabajo.Connected)
                    {
                        if (estadoDelCliente.NextOperation == NextOperationModes.Normal)
                        {
                            try
                            {
                                ...
                                bool willRaiseEvent = estadoDelCliente.socketDeTrabajo.ReceiveAsync(saeaRecepcion);
                                if (!willRaiseEvent)
        ...
        private void procesarEnvioCiclico(T estadoDelCliente)
        {
            ...
            try
            {
                ...
                bool willRaiseEvent = estadoDelCliente.socketDeTrabajo.ReceiveAsync(estadoDelCliente.saeaDeRecepcion);
                if (!willRaiseEvent)
        ...
        /// </summary>
        /// <param name="estadoDelCliente">Objeto con la información y el socket de trabajo sobre el envío</param>
        private void colaDeProcesamiento(T estadoDelCliente)
        {
            ...
            lock (estadoDelCliente.sincronizarEnvio)
            {
                ...
                if (cantMsgsSent > 0)
                {
                    ...
                    try
                    {
                        ...
                        bool willRaiseEvent = estadoDelCliente.socketDeTrabajo.SendAsync(estadoDelCliente.saeaDeEnvio);
                        if (!willRaiseEvent)
                            // si la operación asincrona está pendiente, se completa el flujo,
                            // de manera forzada ya que se tiene asignado un manejador de eventos a esta función
                            // en su evento callback
                            OnIOCompleted(estadoDelCliente.socketDeTrabajo, estadoDelCliente.saeaDeEnvio);
                    }
                    catch (Exception ex)
                    {
